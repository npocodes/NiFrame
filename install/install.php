...
if(isset($_SESSION['install']) && $_SESSION['install'] === true)
{
  ...
  */
  ...
  //Has and Encrypt the root users password
  ...
  if(file_exists("../inc/config.ini") && $Generated != False)
  {
    ...
    */
    ...
    {
      echo("<br>");
      echo("<span style='color:green;'>Installation has finished successfully!.</span><br><br>Redirecting to cortex...");

      ////////////////////
      //%%^^ STEP 7 ^^%%//
      ////////////////////
      //Generate a log File and clean-up
      $log = fopen("../inc/installLog.txt", 'wb') or die("<span style='color:red;'>Error generating installation log file...</span><br><br>");
